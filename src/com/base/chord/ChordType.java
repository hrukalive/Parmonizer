...
public enum ChordType {
    ...
    min7b5("min7b5", new Interval[]{Interval.m3, Interval.d5, Interval.m7},
            new Integer[]{100, -1, -1}, new Integer[]{70, 50, 30, -1}),
    ...
    dim("dim", new Interval[]{Interval.m3, Interval.d5},
            new Integer[]{-1, -1}, new Integer[]{-1, 30, -1}),
    dim7("dim7", new Interval[]{Interval.m3, Interval.d5, Interval.d7},
            new Integer[]{-1, 100, -1}, new Integer[]{-1, 30, -1, -1}),
    aug("aug", new Interval[]{Interval.M3, Interval.A5},
            new Integer[]{-1, -1}, new Integer[]{10, 10, 10}),
    sus4("sus4", new Interval[]{Interval.P4, Interval.P5},
            new Integer[]{-1, 100}, new Integer[]{10, -1, 30}),
    sus2("sus2", new Interval[]{Interval.M2, Interval.P5},
            new Integer[]{-1, 100}, new Integer[]{10, -1, 30}),
    b9sus("sus(b9)", new Interval[]{Interval.P4, Interval.P5, Interval.m9},
            new Integer[]{-1, 100, -1}, new Integer[]{10, -1, 30, -1}),
    power("5", new Interval[]{Interval.P5},
            new Integer[]{-1}, new Integer[]{10, 20}),
    ...
    dom13("13", new Interval[]{Interval.M3, Interval.P5, Interval.m7, Interval.M9, Interval.M13},
            new Integer[]{-1, 10, -1, 80, -1}, new Integer[]{10, 50, 30, -1, -1, -1}),
    dom7b9("7b9", new Interval[]{Interval.M3, Interval.P5, Interval.m7, Interval.m9, Interval.A9, Interval.d5, Interval.M6},
            new Integer[]{-1, 10, -1, -1, 10, 10, 10}, new Integer[]{10, 50, 30, -1, -1, -1, -1, -1}),
    dom7A9("7#9", new Interval[]{Interval.M3, Interval.P5, Interval.m7, Interval.A9},
            new Integer[]{-1, 10, -1, -1}, new Integer[]{10, 50, 30, -1, -1}),
    dom7A11("7#11", new Interval[]{Interval.M3, Interval.P5, Interval.m7, Interval.A11, Interval.M9, Interval.M13},
            new Integer[]{-1, 10, -1, -1, 70, 60}, new Integer[]{10, 50, 30, -1, -1, -1, -1}),
    dom7alt("7alt", new Interval[]{Interval.M3, Interval.m7, Interval.m9, Interval.d5, Interval.m6, Interval.A9},
            new Integer[]{-1, -1, 60, 60, 60, 60}, new Integer[]{10, 50, -1, -1, -1, -1, -1}),
    ...
    dom11sus("11sus", new Interval[]{Interval.P5, Interval.m7, Interval.M9, Interval.P11},
            new Integer[]{50, -1, 80, -1}, new Integer[]{10, 30, -1, -1, -1});
