...
public final class Interval {
        ...
        public String toString() {
            switch (this) {
                ...
                case Dim:
                    return "d";
                default:
                    throw new InternalError("Quality is wrong.");
            }
        }
    }
    ...
    public static Interval parse(String interval) {
        ...
        if (matcher.find()) {
            ...
            if (dirStr != null) {
                if (dirStr.equals("+"))
                    return _intv_str_map.get(nameStr);
                else if (dirStr.equals("-"))
                    return _intv_str_map.get(nameStr).reverse();
                else
    ...
    private Interval(int degree, int semitones, Dir dir, Quality type) {
        this._degree = degree;
        this._semitones = semitones;
        this._dir = dir;
        this._quality = type;
    ...
    private Interval(Interval other) {
        this(other._degree, other._semitones, other._dir, other._quality);
    }

    private Interval(Interval other, Dir dir) {
        this(other._degree, other._semitones, dir, other._quality);
    }
    ...
    public boolean isDiminished() {
        return _quality.equals(Quality.Dim);
    }

    public boolean isMinor() {
        return _quality.equals(Quality.Min);
    }

    public boolean isMajor() {
        return _quality.equals(Quality.Maj);
    }

    public boolean isAugmented() {
        return _quality.equals(Quality.Aug);
    }

    public boolean isPerfect() {
        return _quality.equals(Quality.Per);
    }
    ...
    public Interval reverse() {
        return new Interval(this, (this._dir.equals(Dir.Above) ? Dir.Below : Dir.Above));
    }
